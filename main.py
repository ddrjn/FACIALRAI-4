...
def Train(epochs,train_loader,val_loader,criterion,optmizer,device,fnm="Generic"):
    '''
    Training Loop
    '''
    ...
    torch.save(net.state_dict(),fnm + '.pt')
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        Train(epochs, train_loader, val_loader, criterion, optmizer, device, fnm=args.data)
